...
export default function Register() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 mb-10 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
                    <h1 className="text-2xl font-bold">Create Your Account</h1>
                    <p className="text-blue-100 mt-1">Join us today to get started</p>
                </div>
                ...
                <form onSubmit={handleRegister} className="p-6 space-y-6">
                    <div>
                        ...
                        <input
                            ...
                            required
                            className="w-full px-2 py-2 border text-gray-800 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                        />
                    </div>
                            ...
                            <label className="flex items-center cursor-pointer">
                                <div className="relative">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`block w-10 h-6 rounded-full transition-colors ${showPassword ? 'bg-blue-800' : 'bg-gray-300'}`}></div>
